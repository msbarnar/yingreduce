...
public final class RemotePeerWrapperFactory implements WrapperFactory<LocalPeer, RemotePeer> {
  ...
  @Override
  public RemotePeer createWrapper(final LocalPeer target) {
  ...
  private final class RemotePeerWrapper implements Wrapper<LocalPeer>, RemotePeer {
    ...
    public RemotePeerWrapper(final LocalPeer localPeer) {
    ...
    @Override
    public <T extends Activatable> T getReference(final Class<T> cls) throws RemoteException {
