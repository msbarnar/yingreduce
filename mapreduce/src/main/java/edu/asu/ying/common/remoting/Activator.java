 ...
 * interface. Instances bound will be made accessible publically and a strong reference will be
 * held
...
public interface Activator extends Activatable {
  ...
  /**
   * Binds the class {@code cls} to an exported proxy for {@code instance}. Requests for {@code
   * cls}
  ...
  <R extends Activatable, I extends R> void unbind(Class<R> cls);
