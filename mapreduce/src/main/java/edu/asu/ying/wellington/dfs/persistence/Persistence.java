...
public interface Persistence {
  ...
  /**
   * Reads a page from {@code stream} and stores it locally.
   *
   ...
   *                                   data.
   */
  void storePage(InputStream stream) throws IOException;
   ...
   */
  InputStream readPage(PageIdentifier id) throws IOException;
