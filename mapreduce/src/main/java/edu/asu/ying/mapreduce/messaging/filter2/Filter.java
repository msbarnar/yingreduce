...
public interface Filter
{
	...
	{
		public static final <T> FilterOnEquals<T> doesEqual(final T value) {
			return new on.FilterOnEquals<>(value);
		}
		public static final <T> FilterOnClass classIs(final Class<T> type) {
			return new on.FilterOnClass(type);
		}
		public static final Filter allOf(final Filter... filters) {
			return new on.FilterAllOf(filters);
		}
		public static final Filter anyOf(final Filter... filters) {
			return new on.FilterAnyOf(filters);
		}
		public static final Filter noneOf(final Filter... filters) {
