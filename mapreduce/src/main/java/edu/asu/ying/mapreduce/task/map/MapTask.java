package edu.asu.ying.mapreduce.task.map;

import com.google.common.base.Preconditions;

import java.util.UUID;

import edu.asu.ying.mapreduce.task.InvalidTaskException;
import edu.asu.ying.mapreduce.task.ReducerReference;
import edu.asu.ying.mapreduce.task.Task;
import edu.asu.ying.mapreduce.task.TaskBase;
