 ...
 * following properties are defined on this message: <ul> {@code resource.uri} - the full resource
 * URI, including address. {@code resource.type.name} - the name of the type of resource
 * referenced. {@code resource.instance.name} - (optional) the name of the specific instance of the
 * resource. </ul>
 */
