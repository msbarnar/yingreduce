 ...
 * reference to the resources or an exception. <p> The ID of this message will be the same as that
 * of the {@link ResourceRequest} that instigated it. <p> The following properties are defined on
 * this message: <ul> <li>{@code resources.reference} - (optional) the resources reference, if
