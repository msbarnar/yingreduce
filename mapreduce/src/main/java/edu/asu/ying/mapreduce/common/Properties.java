...
public final class Properties
  ...
  Properties
      Empty =
      new Properties(ImmutableMap.<Serializable, Serializable>of());
  ...
  /**
   * Gets the value of a property cast to the given class. </p> If the cast fails, the returned value
   * is null.
   *
  ...
  /**
   * Gets the value of the property as a {@link String}, returning an empty string if the value was
   * null.
   */
