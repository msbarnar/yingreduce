 ...
 * <p> This is the heart of data reference in the network; the {@code Table} is how table and reduce
 * functions reference their target data. <p> Local {@code Table} objects are proxies to remote
 * tables. When data are put into the map locally, they are distributed about the network. <p> Each
...
public interface Table
  ...
  /**
   * Persists dirty pages. On a client node, this means distributing them to the network. On a server
