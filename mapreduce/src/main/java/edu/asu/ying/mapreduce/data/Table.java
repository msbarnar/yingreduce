 ...
 * <p>
 * This is the heart of data reference in the network; the {@code Table} is how table and reduce functions
 * reference their target data.
 * <p>
 * Local {@code Table} objects are proxies to remote tables. When data are put into the map locally, they are
	...
	extends Map<Serializable, Serializable>, RemoteResource
{
	 ...
	 * {@code Page} objects. All pages in a table must be sequential and continuous for the {@code Table} to
	 * remain consistent.
	 *
	 * @see RemoteResource
	 */
